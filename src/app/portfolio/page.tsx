...
const projects = [
  ...
  },
  {
    ...
    tags: ["SEO", "Automatisation IA", "Google Analytics", "WordPress"],
    desc: "Automatisation des process marketing grâce à l'IA. Rédaction et optimisation SEO de contenus web. Pilotage de campagnes SEO, développement de stratégies de mots-clés et analyse des performances.",
