...
const experiences = [
  {
    ...
    tasks: [
      ...
      "Prompt engineering : conception et optimisation de prompts pour audits, automatisations et workflows IA",
      "Gestion de projet : planification des livrables, priorités et suivi des deadlines",
      "Coordination des missions clients et pilotage des étapes d'audit jusqu'à la livraison",
